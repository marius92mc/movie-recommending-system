...
/******/ 	var hotCurrentHash = "f9623565e3b05ff1fa75"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsFacebook_loginFacebook = __webpack_require__(169);

	var _componentsFacebook_loginFacebook2 = _interopRequireDefault(_componentsFacebook_loginFacebook);
	...
	var Content = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(_componentsFacebook_loginFacebook2['default'], {
	...
	_reactDom2['default'].render(_react2['default'].createElement(Content, null), document.getElementById('demo'));
	/*
	ReactDOM.render(
	  <FacebookLogin
	    appId="361217287335942"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _facebookScss = __webpack_require__(170);

	var _facebookScss2 = _interopRequireDefault(_facebookScss);
	...
	var FacebookLogin = (function (_React$Component) {
	  ...
	  FacebookLogin.prototype.componentDidMount = function componentDidMount() {
	    ...
	    (function (d, s, id) {
	      ...
	      js.src = '//connect.facebook.net/' + _this2.props.language + '/sdk.js';
	  ...
	  FacebookLogin.prototype.renderWithFontAwesome = function renderWithFontAwesome() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('style', { dangerouslySetInnerHTML: { __html: _facebookScss2['default'] } })
	    );
	  };
